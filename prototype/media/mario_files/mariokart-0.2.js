...
var oMaps = {
	"map1" : {
		"texture" : "/media/mario_files/map_1.png",
		"width" : 512,
		"height" : 512,
		"collision" : [
			[84,80,52,216],
	...
	"map2" : {
		"texture" : "/media/mario_files/map_2.png",
		"width" : 512,
		"height" : 512,
		"collision" : [
			[120,116,8,228],
...
function startGame() {
	...
	oCountImg.src = "/media/mario_files/countdown.png";
...
function Sprite(strSprite)
{
	...
	oImg.src = "/media/mario_files/sprite_" + strSprite + (bSmoothSprites ? "_smooth" : "") + ".png";
...
function BGLayer(strImage, iLayerWidth) {
	...
	oImg1.src = "/media/mario_files/bg_" + strImage + ".png";
	...
	oImg2.src = "/media/mario_files/bg_" + strImage + ".png";
	...
	function selectPlayerScreen() {
		...
		oTitle.src = "/media/mario_files/title.png";
		...
		for (var i=0;i<aPlayers.length;i++) {
			...
			oPImg.src = "/media/mario_files/select_" + aPlayers[i] + ".png";
	...
	function selectMapScreen() {
		...
		var oTitle = document.createElement("img");
		oTitle.src = "/media/mario_files/mushroomcup.png";
		oTitle.style.position = "absolute";
		...
		for (var i=0;i<aAvailableMaps.length;i++) {
			var oPImg = document.createElement("img");
			oPImg.src = "/media/mario_files/select_" + aAvailableMaps[i] + ".png";
	...
	for (var i=0;i<aPlayers.length;i++) {
		var oImg = new Image();
		oImg.src = "/media/mario_files/sprite_" + aPlayers[i] + "_smooth.png";
	}
