...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Challenge.completed'
        db.delete_column(u'prototype_app_challenge', 'completed')

        # Adding field 'Challenge.complete'
        db.add_column(u'prototype_app_challenge', 'complete',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Challenge.completed'
        db.add_column(u'prototype_app_challenge', 'completed',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Challenge.complete'
        db.delete_column(u'prototype_app_challenge', 'complete')
    ...
    models = {
        ...
        u'facebook.facebookprofile': {
            ...
            'coins': ('django.db.models.fields.IntegerField', [], {'default': '10', 'null': 'True', 'blank': 'True'}),
        ...
        u'prototype_app.challenge': {
            ...
            'complete': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
