...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Challenge.complete'
        db.alter_column(u'prototype_app_challenge', 'complete', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Challenge.complete'
        db.alter_column(u'prototype_app_challenge', 'complete', self.gf('django.db.models.fields.BooleanField')())
