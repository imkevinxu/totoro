...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DriveData.fuel_used'
        db.add_column('prototype_app_drivedata', 'fuel_used',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DriveData.fuel_used'
        db.delete_column('prototype_app_drivedata', 'fuel_used')
