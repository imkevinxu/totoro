...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'facebook_facebookprofile', 'rpm',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FacebookProfile.mpg'
        db.add_column(u'facebook_facebookprofile', 'mpg',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FacebookProfile.speed'
        db.add_column(u'facebook_facebookprofile', 'speed',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FacebookProfile.maf'
        db.add_column(u'facebook_facebookprofile', 'maf',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FacebookProfile.runsec'
        db.add_column(u'facebook_facebookprofile', 'runsec',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FacebookProfile.warmups'
        db.add_column(u'facebook_facebookprofile', 'warmups',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FacebookProfile.barometer'
        db.add_column(u'facebook_facebookprofile', 'barometer',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FacebookProfile.ambienttemp'
        db.add_column(u'facebook_facebookprofile', 'ambienttemp',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FacebookProfile.throttle'
        db.add_column(u'facebook_facebookprofile', 'throttle',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'facebook_facebookprofile', 'rpm')

        # Deleting field 'FacebookProfile.mpg'
        db.delete_column(u'facebook_facebookprofile', 'mpg')

        # Deleting field 'FacebookProfile.speed'
        db.delete_column(u'facebook_facebookprofile', 'speed')

        # Deleting field 'FacebookProfile.maf'
        db.delete_column(u'facebook_facebookprofile', 'maf')

        # Deleting field 'FacebookProfile.runsec'
        db.delete_column(u'facebook_facebookprofile', 'runsec')

        # Deleting field 'FacebookProfile.warmups'
        db.delete_column(u'facebook_facebookprofile', 'warmups')

        # Deleting field 'FacebookProfile.barometer'
        db.delete_column(u'facebook_facebookprofile', 'barometer')

        # Deleting field 'FacebookProfile.ambienttemp'
        db.delete_column(u'facebook_facebookprofile', 'ambienttemp')

        # Deleting field 'FacebookProfile.throttle'
        db.delete_column(u'facebook_facebookprofile', 'throttle')
